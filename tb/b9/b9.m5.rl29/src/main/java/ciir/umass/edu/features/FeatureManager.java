	...
	public static List<RankList> readInput(String inputFile, boolean mustHaveRelDoc, boolean useSparseRepresentation)	
	{
		...
		try {
			...
			while((content = in.readLine()) != null)
			{
				...
				//System.out.println("\nFeaMan: readInput content=" + content); //yyl
				...
				//System.out.println("FeaMan: readInput fid=" + qp.getID() ); //yyl

				//System.out.println("FeaMan: readInput lastID: "+lastID );//yyl
				...
				//System.out.println("FeaMan: readInput dp.getLabel: "+qp.getLabel() );//yyl
			...
			//System.out.println("FeaMan: readInput rl.size: "+rl.size() );//yyl

			if(rl.size() > 0 && (!mustHaveRelDoc || hasRel)) {
				samples.add(new RankList(rl));
				//System.out.println("FeaMan: add to samples here ");//yyl
			}
